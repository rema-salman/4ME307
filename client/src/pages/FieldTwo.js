...
function FieldTwo() {
  ...
  useEffect(() => {
    ...
    fields_stationRef.on("value", (snapshot) => {
      ...
      for (let id in fields_station_info) {
        ...
        soil_moisture_list.push(fields_station_info[id].field_2.soil_moisture);
      }
    ...
    const motorTwoRef = firebasedDB.ref("irrigation_status/motor_two");
  ...
  return (
    <div>
      <h3 className="text-center">Field Two</h3>
